...
def get_seg_model_vcf(name, num_classes, vcf_num_classes, vcf_mode=1, p3=0.0, p4=0.0, p5=0.0): # model_pretrained, imgnet_pretrained=False,
    ...
    if 'pidnet_s' == name:
        ...
        model = PIDNet_vcf(m=3, n=4, num_classes=num_classes, vcf_num_classes=vcf_num_classes, vcf_mode=vcf_mode, planes=64, ppm_planes=112, head_planes=256, augment=True,
                      p3=p3, p4=p4, p5=p5)
    return model
def get_seg_model_vcf_cls(name, num_classes, vcf_num_classes, vcf_mode=1, p3=0.0, p4=0.0, p5=0.0): # model_pretrained, imgnet_pretrained=False,
    
    if 'pidnet_s' == name:
        model = PIDNet_vcf_cls(m=2, n=3, num_classes=num_classes, vcf_num_classes=vcf_num_classes, vcf_mode=vcf_mode, planes=32, ppm_planes=96, head_planes=128, augment=True,
                      p3=p3, p4=p4, p5=p5)
    elif 'pidnet_m' == name:
        model = PIDNet_vcf_cls(m=2, n=3, num_classes=num_classes, vcf_num_classes=vcf_num_classes, vcf_mode=vcf_mode, planes=64, ppm_planes=96, head_planes=128, augment=True,
                      p3=p3, p4=p4, p5=p5)
    elif 'pidnet_l' == name:
        model = PIDNet_vcf_cls(m=3, n=4, num_classes=num_classes, vcf_num_classes=vcf_num_classes, vcf_mode=vcf_mode, planes=64, ppm_planes=112, head_planes=256, augment=True,
                      p3=p3, p4=p4, p5=p5)
    return model
#-------------------------------------------------------------------------------------------
# 
