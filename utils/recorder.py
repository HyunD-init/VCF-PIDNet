...
class Recorder():
    ...
    def __init__(self, record_dir: str, model: 'model', optimizer: 'optimizer',
                 scheduler: 'scheduler', logger: logging.RootLogger=None):
    ...
    def add_row(self, row_dict: dict):
        ...
        with open(self.record_filepath, newline='', mode='a', encoding='UTF8') as f:
